...
export type ViewPerspective = 'exterior-iso' | 'front-elevation' | 'top-down-floorplan' | 'interior-walkthrough' | 'bedroom-suite' | 'living-lounge' | 'back-patio' | 'rooftop-terrace' | 'rooftop-observatory';
